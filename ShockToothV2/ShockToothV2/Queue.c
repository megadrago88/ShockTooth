...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = ShockToothV2EvtIoDeviceControl;
    queueConfig.EvtIoStop = ShockToothV2EvtIoStop;
...
VOID
ShockToothV2EvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
